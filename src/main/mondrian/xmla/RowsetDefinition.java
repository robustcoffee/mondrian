...
import org.olap4j.metadata.XmlaConstants.ActionType;
...
public enum RowsetDefinition {
   ...
   static class DiscoverSchemaRowsetsRowset extends Rowset {
      ...
      private List<XmlElement> getRestrictions(RowsetDefinition rowsetDefinition) {
         ...
         List mdschemaMeasures = new ArrayList();
         for (Column column : columns) {
            if (column.restriction) {
               
//               if(rowsetDefinition.name().equals("MDSCHEMA_PROPERTIES")){
//                  if(column.name.equals("PROPERTY_TYPE")){
//                     mdschemaMeasures.add(column.name);
//                     mdschemaMeasures.add(column.getColumnType());
//                     continue;
//                  }
//                  else if(column.name.equals("PROPERTY_NAME") && mdschemaMeasures.size()==2){
//                     mdschemaMeasures.add(column.name);
//                     mdschemaMeasures.add(column.getColumnType());
//                     restrictionList.add(new XmlElement(Restrictions.name, null, new XmlElement[] { new XmlElement("Name", null, mdschemaMeasures.get(2).toString()),
//                              new XmlElement("Type", null,  mdschemaMeasures.get(3).toString()) }));
//                     restrictionList.add(new XmlElement(Restrictions.name, null, new XmlElement[] { new XmlElement("Name", null, mdschemaMeasures.get(0).toString()),
//                              new XmlElement("Type", null,  mdschemaMeasures.get(1).toString()) }));
//                     mdschemaMeasures = null;
//                     continue;
//                  }
//               }
   ...
   public static class MdschemaMeasuresRowset extends Rowset {
      ...
      private static final Column MeasureNameSql = new Column("MEASURE_NAME_SQL_COLUMN_NAME", Type.String, null, Column.RESTRICTION, Column.OPTIONAL,
...
//         }
   ...
   static class MdschemaSetsRowset extends Rowset {
      ...
      private static final Column SetEvaluationContext = new Column("SET_EVALUATION_CONTEXT", Type.String, null, false, true, "");
